                                ...
                                <div class="row">
                                    <div class="col-auto form-group" id="dropdownTabelRingkasan">
                                        <select class="form-control" style="width: 100%; max-width: 600px" id="selectTableRingkasan">
                                            ...
                                            <option value="perbandingan-pertumbuhan-Y-ON-Y" id="16" selected>Tabel 1.16. Perbandingan Pertumbuhan Ekonomi Provinsi DKI Jakarta dan 6 Kabupaten/Kota (Y-ON-Y)</option>
